...
from ntlm.constants import NTLMSSP_NEGOTIATE_56, NTLMSSP_NEGOTIATE_KEY_EXCH, NTLMSSP_NEGOTIATE_128, \
							NTLMSSP_NEGOTIATE_VERSION, NTLMSSP_NEGOTIATE_TARGET_INFO, NTLMSSP_REQUEST_NON_NT_SESSION_KEY,\
							NTLMSSP_NEGOTIATE_IDENTIFY, NTLMSSP_NEGOTIATE_EXTENDED_SESSIONSECURITY, NTLMSSP_TARGET_TYPE_SHARE,\
							NTLMSSP_TARGET_TYPE_SERVER,NTLMSSP_TARGET_TYPE_DOMAIN, NTLMSSP_NEGOTIATE_ALWAYS_SIGN,\
							NTLMSSP_NEGOTIATE_OEM_WORKSTATION_SUPPLIED, NTLMSSP_NEGOTIATE_OEM_DOMAIN_SUPPLIED, NTLMSSP_ANONYMOUS, \
							NTLMSSP_NEGOTIATE_NTLM, NTLMSSP_NEGOTIATE_LM_KEY, NTLMSSP_NEGOTIATE_DATAGRAM, \
